# Issue Tracker: https://hub.fgit.ml/ScoopInstaller/Install/issues
# Unlicense License:
#
...
function Test-Prerequisite {
    ...
    if (!$RunAsAdmin -and (Test-IsAdministrator)) {
        ...
        if (!$exception) {
            Deny-Install 'Running the installer as administrator is disabled by default, see https://hub.fgit.ml/ScoopInstaller/Install#for-admin for details.'
        }
    }
...
function Expand-ZipArchive {
    ...
    # upstream issue: https://hub.fgit.ml/PowerShell/Microsoft.PowerShell.Archive/issues/98
...
$SCOOP_PACKAGE_REPO = 'https://hub.fgit.ml/ScoopInstaller/Scoop/archive/master.zip'
$SCOOP_MAIN_BUCKET_REPO = 'https://hub.fgit.ml/ScoopInstaller/Main/archive/master.zip'

$SCOOP_PACKAGE_GIT_REPO = 'https://hub.fgit.ml/ScoopInstaller/Scoop.git'
$SCOOP_MAIN_BUCKET_GIT_REPO = 'https://hub.fgit.ml/ScoopInstaller/Main.git'
