...
.LINK
    https://scoop.sh
.LINK
    https://hub.fgit.ml/ScoopInstaller/Scoop/wiki
#>
param(
    [Parameter(Position = 0)][String] $SoftUrl = "https://raw.fastgit.org/zxw7606/FirstDayOfWork/master/dist/group.speedup.json",
    [String] $ScoopDir,
...
function Install-Scoop {
    ...
    #     @{
    #         "bucket-name" = "main"
    #         "bucket-url"  = "https://hub.fgit.ml/ScoopInstaller/Main"
    #     },
    #     @{
    #         "bucket-name" = "extras"
    #         "bucket-url"  = "https://hub.fgit.ml/ScoopInstaller/Extras"
    #     },
    #     @{
    #         "bucket-name" = "java"
    #         "bucket-url"  = "https://hub.fgit.ml/ScoopInstaller/Java"
    #     }
    # )
...
function Install-Software {
    ...
    #æç¤ºç”¨æˆ·é€‰æ‹©è½¯ä»¶åˆ†ç»„å¹¶è¿›è¡Œå®‰è£…
...
$SCOOP_INSALL_SH_URL = "https://raw.fastgit.org/zxw7606/FirstDayOfWork/master/back/installscoop.speedup.ps1"
# $SCOOP_INSALL_SH_URL = "http://ghproxy.com/https://raw.fastgit.org/zxw7606/FirstDayOfWork/master/back/installscoop.speedup.ps1"
$I18N_URL = "https://raw.fastgit.org/zxw7606/FirstDayOfWork/master/i18n/{0}.json"
# $I18N_URL = "http://ghproxy.com/https://raw.fastgit.org/zxw7606/FirstDayOfWork/master/i18n/{0}.json"
$I18N_HELPER = ''
